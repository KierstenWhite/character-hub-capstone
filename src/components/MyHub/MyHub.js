    ...
    return (
        ...
        <Card id="individualCard" color="purple">
            ...
            <Card.Content id="cardContent">
                <Card.Description id="cardDescription">Visit all of your exisiting characters, make edits, and share.</Card.Description>
        ...
        <Card id="individualCard" color="purple">
            ...
            <Card.Content id="cardContent">
                <Card.Description id="cardDescription">Have an idea for a new character? Start here.</Card.Description>
        ...
        <Card id="individualCard" color="purple">
            ...
            <Card.Content id="cardContent">
                <Card.Description id="cardDescription">Our crowd sourced Writing Resources tab will have something for everyone.</Card.Description>
