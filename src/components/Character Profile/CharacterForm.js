//Handles all data and JSX for new characters added from the Add New Character Form
  ...
  return (
    <>
      <Form id="addNewCharacterForm">
        <Header as="h2" id="formTextHeader">
          Add a New Character Form
          <Header.Subheader>
            Indulge your muse by starting a new character profile. There are
            multiple fields that can be used. You can come back and edit this
            form at any time, meaning you don't have to know everything in one
            sitting. The only required fields to save a form are First and Last
            Name.
          </Header.Subheader>
        </Header>
        ...
        <hr id="lineBreakOne"></hr>
        <Header as="h3">Character Profile Details</Header>
        ...
        <hr id="lineBreakOne"></hr>
        <Header as="h3">Physical Details</Header>
        ...
        <hr id="lineBreakOne"></hr>
        <Header as="h3">Narratives</Header>
        <Form.Field
          control={TextArea}
          onChange={(evt) => {
            const copy = { ...character };
