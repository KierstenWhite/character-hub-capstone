//Handles data submitted for a new user account and JSX for registration form
  ...
  return (
    <>
      <Segment id="headerSegment">
        <img
          src="https://i.imgur.com/QoFHnAR.png"
          alt="Character Hub Logo"
          id="characterHubLogo"
        />
      </Segment>
      <Header id="registrationFormHeader" as="h1">
        <Header.Subheader id="registrationQuote">
          <img
            src="https://i.imgur.com/sTu4G22.png"
            id="registrationQuoteImage"
          />
        </Header.Subheader>
      ...
      <Form className="ui form" id="registrationForm" onSubmit={handleRegister}>
        ...
        <Form.Field
          ...
          id="bio"
        />
        <Form.Field control={Button} id="registrationButton">
